...
| Z    | 1            | Zero Flag (based on A Register)          | `0`              |
| B    | 1            | Borrow Flag (based on last Calculation)  | `0`              |
| C    | 1            | Carry Flag (based on last Calculation)   | `0`              |
| P    | 1            | Parity Flag (based on A Register)        | `0`              | 
